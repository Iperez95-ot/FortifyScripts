...
- **EDirectory Application 9.3.3**.
- **EDirectory API 26.1**.
- **IdentityConsole 26.1**.
...
|---------|-------------|---------|
| `EDIRECTORY_VERSION` | 🧱 EDirectory version to install | `9.3.3` |
| `EDIRECTORY_VERSION_FULL` | 🔢 Version number without dots | `933` |
| `IDENTITYCONSOLE_VERSION` | 🖥️ IdentityConsole version to install | `26.1` |
| `IDENTITYCONSOLE_VERSION_FULL` | 🔢 Version number without dots | `261` |
...
3. Make the script executable
   ```bash
   chmod +x edirectory_933_identityconsole_261_files_pull.sh
   ```  
4. Run the script as:
   ```bash
   ./edirectory_933_identityconsole_261_files_pull.sh
   ```
